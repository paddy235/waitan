...
public class ReportDocxController {
	...
	public Object downloadFile(HttpServletRequest request,  String bbdQyxxId, @RequestParam String companyName )  {
	...
	@ResponseBody
	public Object getFileUrl(HttpServletRequest request,  String bbdQyxxId, @RequestParam String companyName )  {
		if( bbdQyxxId ==null && companyName ==null ) {
			return ResponseBean.errorResponse("parameters is error.");
		}
