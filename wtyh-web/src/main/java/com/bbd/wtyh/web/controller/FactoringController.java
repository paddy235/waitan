...
public class FactoringController {
	...
	public Object insideOutside() {
		...
		XAxisSeriesLinesBean<Integer, Integer> dto = new XAxisSeriesLinesBean<>(new ArrayList<Integer>(), new ArrayList<Integer>());
	...
	@ResponseBody
	@LogRecord(logMsg = "浏览商业保理页面", page = Operation.Page.factoring)
