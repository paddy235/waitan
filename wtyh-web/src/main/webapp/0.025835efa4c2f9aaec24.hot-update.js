	        ...
	        var option = {
	            tooltip: {
	                ...
	                formatter: function formatter(v) {
	                    ...
	                    var typeLabel = null;
	                    //这个就是hover点的ajax方法。
	                    var hoverName = v.name;
	                    console.log(hoverName, "name");
	                    console.log(hoverName.toString(), "name转字符串");
	                    console.log(ajaxDataSH.SHhoverDot, "ajax返回的");
	                    console.log(ajaxDataSH.SHhoverDot[hoverName.toString()], "结合正式版本");
	                    console.log(ajaxDataSH.SHhoverDot["撰谦（上海）投资咨询有限公司"], "结合测试版本");
	                    var numORdate = ajaxDataSH.SHhoverDot[hoverName.toString()];
