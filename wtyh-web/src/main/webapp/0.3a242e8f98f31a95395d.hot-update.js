	...
	var RefereeDocuments = _react2.default.createClass({
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	    ...
	    if (nextProps.CompanyInfoC2Request) {
	      ...
	      // 				return (<div className="content-content clear-fix">
	      // <div>1</div><div>成都市金牛区人民法院</div><div>申请人潘文财依据北京市第二中级人民法院作出的民事判决，向北京市通州区人民法院申请执行，要被执行人中扶建设有限责任公司北京路通同泰建筑分公司（以下简称路通同泰建筑分公司）给付货款、违约金、迟延履行期间的债务利息，共计115万余元。执行法院通过相关查询、现场勘查，发现路通同泰建筑分公司没有能力履行全部债务。</div><div>相关法人</div><div>2016年6月7日</div>
	      // </div>)
	      // 			})
