...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopRight = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        if (!!paramTwo) {
	            paramOneBox = _react2.default.createElement(_LineBarChart2.default, { param: paramTwo, style: { height: '100%', width: '100%' } });
	        }
	        if (!!paramThree) {
	            paramOneBox = _react2.default.createElement(_LineBarChart2.default, { param: paramThree, style: { height: '100%', width: '100%' } });
	        }
	        if (!!paramFour) {
	            paramOneBox = _react2.default.createElement(_LineBarChart2.default, { param: paramFour, style: { height: '100%', width: '100%' } });
	        }
	        if (!!paramFive) {
	            paramOneBox = _react2.default.createElement(_LineBarChart2.default, { param: paramFive, style: { height: '100%', width: '100%' } });
	        }
	        if (!!paramSix) {
	            paramOneBox = _react2.default.createElement(_LineBarChart2.default, { param: paramSix, style: { height: '100%', width: '100%' } });
	        }
	        if (!!paramSeven) {
	            paramOneBox = _react2.default.createElement(_ScatterChart2.default, { param: paramSeven, style: { height: '100%', width: '100%' } });
	        }
	        if (!!paramEight) {
	            paramOneBox = _react2.default.createElement(_LineBarChart2.default, { param: paramEight, style: { height: '100%', width: '100%' } });
	        }
	        if (!!paramNine) {
	            paramOneBox = _react2.default.createElement(_LineBarChart2.default, { param: paramNine, style: { height: '100%', width: '100%' } });
	        }
