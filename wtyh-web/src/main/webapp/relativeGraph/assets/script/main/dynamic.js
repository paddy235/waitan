                    ...
                    var shtml = '<div class="relation-modal"><div class="company-title">' + name + '<span class="iconfont icon-iconfontshequyijujue"></span></div>\
                      <table>\
                        <tbody>\
                          ...
                          <tr><td>登记状态</td><td>' + registation + '</td></tr>\
                          <tr><td>关联方法人节点数</td><td>' + legalPersonNodes + '</td></tr>\
                          <tr><td>关联方自然人节点数</td><td>' + naturalPersonNode + '</td></tr>\
                          <tr><td>自然人股东数</td><td>' + naturalPersonShareholders + '</td></tr>\
                          <tr><td>法人股东数</td><td>' + legalPersonShareholders + '</td></tr>\
                          <tr><td>子公司数</td><td>' + subsidiarys + '</td></tr>\
                        </tbody>\
                      </table>\
                  </div>';
