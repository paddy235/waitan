...
/***/ function(module, exports, __webpack_require__) {
	...
	var SHData = [[{ name: '上海' }, { name: '黄浦区', value: 95 }], [{ name: '浦东新区', value: 90 }], [{ name: '徐汇区', value: 80 }], [{ name: '长宁区', value: 70 }], [{ name: '静安区', value: 60 }], [{ name: '普陀区', value: 50 }], [{ name: '虹口区', value: 40 }], [{ name: '杨浦区', value: 30 }]];
