	...
	var TopLeft = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'ul',
	        { className: 'title', 'data-a': '1', 'data-b': '2', onClick: this.titleRange },
	        _react2.default.createElement(
	          'li',
	          { 'data-range': '4', 'data-fixRange': '1' },
	          '重点关注'
	        ),
	        _react2.default.createElement(
	          'li',
	          { 'data-range': '3', 'data-fixRange': '2' },
	          '一般关注'
	        ),
	        _react2.default.createElement(
	          'li',
	          { 'data-range': '2', 'data-fixRange': '3' },
	          '正常'
	        ),
	        _react2.default.createElement(
	          'li',
	          { 'data-range': '1', 'data-fixRange': '4' },
	          '已出风险'
	        )
	      ),
	      this.state.table,
