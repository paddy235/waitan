...
/***/ function(module, exports, __webpack_require__) {
	...
	var BottomRight = _react2.default.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    console.log("-------->", realTimeNewsResult);
	  },
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	    ...
	    if (!isEqual) {
	      ...
	      var _realTimeNewsResult = nextProps.realTimeNewsResult;

	      if (realTimeNewsRequest == true) {
	        if (realTimeNewsRequest == true) {
	          console.log(_realTimeNewsResult, "top");
	          var data = JSON.parse(_realTimeNewsResult);
