    ...
    var methods = {
        ...
        set: function (newValue, animationTimes) {
            ...
            $.each(this, function () {
                ...
                // 只执行一次 add By Mantou
                if(!$this.data("mark")){
                    $this.find("div[data-numberanimate-pos='3']").before("<span class='dot'>,</span>");
                    $this.find("div[data-numberanimate-pos='6']").before("<span class='dot'>,</span>");
                    $this.find("div[data-numberanimate-pos='9']").before("<span class='dot'>,</span>");
                    $this.data("mark",true);
                }
