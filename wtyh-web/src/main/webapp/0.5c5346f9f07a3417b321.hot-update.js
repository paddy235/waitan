	...
	var HomeTwo = _react2.default.createClass({
	    ...
	    initMap: function initMap() {
	        ...
	        var option = {
	            ...
	            //         },
	            //         pieces:[
	            //             {value: 4, label: '123（自定义特殊颜色）', color: 'red'},
	            //             {value: 3, label: '123（自定义特殊颜色）', color: 'yellow'},
	            //             {value: 2, label: '123（自定义特殊颜色）', color: 'green'},
	            //             {value: 1, label: '123（自定义特殊颜色）', color: 'black'}
	            //         ],
	            //         inRange: {
	            //             color: ['red',"green"]
	            //         }
