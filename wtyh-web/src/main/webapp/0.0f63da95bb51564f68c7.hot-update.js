	        ...
	        if (!isEqual) {
	            ...
	            if (realTimeNineRequest == true) {
	                if (realTimeNineRequest == true) {
	                    ...
	                    paramOne.title = "xxxxxxxxxxxxx";
	                    var paramOneAjax = paramOne.clone();
	                    this.setState({
	                        paramOneBox: _react2.default.createElement(_ScatterChart2.default, { param: paramOneAjax })
	                    });
	                } else {
	                    alert(404);
	                }
