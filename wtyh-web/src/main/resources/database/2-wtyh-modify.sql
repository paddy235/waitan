...
-- ----------------------------
INSERT INTO `timing_task_info` (`id`, `task_name`, `task_key`, `task_group`, `cron`, `cron_desc`, `target_class`, `target_method`, `description`, `data_source`, `is_show`) VALUES (1, '企业基本信息更新', 'companyBaseInfoJob', 'job_work', '0 30 18 1 * ?', '每月1号18:30', 'com.bbd.bgo.service.task.SystemDataUpdateServiceImpl', 'start', '更新company表的企业基本信息', 1, 1);
INSERT INTO `timing_task_info` (`id`, `task_name`, `task_key`, `task_group`, `cron`, `cron_desc`, `target_class`, `target_method`, `description`, `data_source`, `is_show`) VALUES (2, '企业风险等级更新', 'riskLevelJob', 'job_work', '0 30 18 6,21 * ?', '每月6号、21号18:30', 'com.bbd.wtyh.service.impl.OfflineFinanceServiceImpl', 'start', '更新company表的企业风险等级', 1, 1);
INSERT INTO `timing_task_info` (`id`, `task_name`, `task_key`, `task_group`, `cron`, `cron_desc`, `target_class`, `target_method`, `description`, `data_source`, `is_show`) VALUES (3, '企业与网贷平台对照表更新', 'platformJob', 'job_work', '0 30 22 10 * ?', '每月10号22:30', 'com.bbd.bgo.service.task.PlatUpdateTaskServiceImpl', 'start', '更新platform_name_information表的信息', 1, 1);
INSERT INTO `timing_task_info` (`id`, `task_name`, `task_key`, `task_group`, `cron`, `cron_desc`, `target_class`, `target_method`, `description`, `data_source`, `is_show`) VALUES (4, 'BBD企业全息舆情数据更新', 'holographicAndOpinionJob', 'bbd_work', '0 30 18 * * ?', '每天18:30', 'com.bbd.bgo.service.task.DataLoadingServiceImpl', 'start', '企业全息数据和舆情数据落地', 1, 1);
INSERT INTO `timing_task_info` (`id`, `task_name`, `task_key`, `task_group`, `cron`, `cron_desc`, `target_class`, `target_method`, `description`, `data_source`, `is_show`) VALUES (5, '线下理财风险数据', 'offlineFinanceJob', 'bbd_work', '0 30 18 5,20 * ?', '每月5号、20号18:30', 'com.bbd.bgo.service.task.SyncFileServiceImpl', 'start', '线下理财数据落地', 1, 1);
INSERT INTO `timing_task_info` (`id`, `task_name`, `task_key`, `task_group`, `cron`, `cron_desc`, `target_class`, `target_method`, `description`, `data_source`, `is_show`) VALUES (6, '网络借贷数据更新', 'p2pMonitorJob', 'wd_work', '0 30 18 * * ?', '每天18:30', 'com.bbd.wtyh.service.impl.PToPMonitorServiceImpl', 'start', '网络借贷数据和舆情数据落地', 2, 1);
INSERT INTO `timing_task_info` (`id`, `task_name`, `task_key`, `task_group`, `cron`, `cron_desc`, `target_class`, `target_method`, `description`, `data_source`, `is_show`) VALUES (7, '众筹数更新', 'crowdFundingJob', 'wd_work', '0 30 18 10 * ?', '每月10号18:30', 'com.bbd.wtyh.service.impl.CrowdFundingServiceImpl', 'start', '众筹数据落地', 2, 1);
INSERT INTO `timing_task_info` (`id`, `task_name`, `task_key`, `task_group`, `cron`, `cron_desc`, `target_class`, `target_method`, `description`, `data_source`, `is_show`) VALUES (8, '网络借贷平台画像更新', 'p2pImageJob', 'wd_work', '0 30 18 10 * ?', '每月10号18:30', 'com.bbd.wtyh.service.impl.P2PImageServiceImpl', 'start', '网络借贷平台画像数据落地', 2, 1);
INSERT INTO `timing_task_info` (`id`, `task_name`, `task_key`, `task_group`, `cron`, `cron_desc`, `target_class`, `target_method`, `description`, `data_source`, `is_show`) VALUES (9, '公信中心数据更新', 'shangHaiCreditJob', 'credit_work', '0 30 18 ? * 6', '每周五 18:30', 'com.bbd.wtyh.service.impl.CoCreditScoreServiceImpl', 'start', '公信中心数据落地', 3, 1);
INSERT INTO `timing_task_info` (`id`, `task_name`, `task_key`, `task_group`, `cron`, `cron_desc`, `target_class`, `target_method`, `description`, `data_source`, `is_show`) VALUES (10, '停止公信中心数据更新', 'closeShangHaiCreditJob', 'credit_work', '0 0 7 ? * 2', '每周一 7:00', 'com.bbd.wtyh.service.impl.CoCreditServiceCloseImpl', 'start', '公信中心数据落地任务停止', 3, 0);
...
UPDATE company SET previous_risk_level = null, risk_level = null WHERE company_type in (2, 3);
