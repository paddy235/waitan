...
public class RiskChgCoDo {
     ...
     *
     * @param riskLevel 公司当前风险等级，1:已出风险(黑) 2:重点关注(红) 3:一般关注(黄) 4:正常(绿)
     */
     ...
     *
     * @param oldRiskLevel 公司原始风险等级，1:已出风险(黑) 2:重点关注(红) 3:一般关注(黄) 4:正常(绿)
     */
