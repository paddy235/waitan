...
public class CompanyStatusChangeDO {
	 ...
	 * 11.预付卡 12.典当 13融资租赁
	 *
	 * @return oldCompanyType 公司类型 1:P2P 2:小贷 3:融资担保 4:线下理财 5:私募基金 6:众筹 7:其他
	 *         8:金融 9:交易所 10:商业保理 11.预付卡 12.典当 13融资租赁
	 */
	...
	public String getClosedTypeName() {
		...
		for (CompanyClosedType t : types) {
			if (t.type().equals(closedType)) {
				return t.desc();
			}
		}
